...
String ssid ="Cafe Moc.";

String password="cafemoc25";

SoftwareSerial esp(6, 7);// RX, TX

String data;

String server = "doanvdk.netne.net"; //

String uri = "http://doanvdk.netne.net/light.json";// full.php
...
void httppost () {
  ...
  while (esp.available()) {
    ...
    if(a>200){
      ...
      if(tmpResp[10]=='1') analogWrite(11,255);
      else digitalWrite(11,LOW); 
     
     // aJsonObject* jsonObject = aJson.parse(tmpResp);
